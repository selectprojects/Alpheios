...
-->
<xsl:stylesheet xmlns="http://www.w3.org/1999/xhtml" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:tei="http://www.tei-c.org/ns/1.0" exclude-result-prefixes="tei" version="1.0">
            ...
            <body>
                ...
                <div id="toc" class="alpheios-ignore">
                    <xsl:call-template name="toc">
                        <xsl:with-param name="a_tocBody" select="tei:TEI/tei:text/tei:front/tei:div[@type='contents']"/>
                    </xsl:call-template>
                </div>
            </body>
        </html>
            ...
            <xsl:choose>
                ...
                <xsl:otherwise>
                    ...
                    <xsl:attribute name="href">
                        <xsl:value-of select="tei:ptr[@rend='toc']/@target"/>
                    </xsl:attribute>
                    <xsl:value-of select="normalize-space(text())"/>
                </xsl:otherwise>
            </xsl:choose>
    ...
    <xsl:template name="javascriptHook">
        ...
        <script type="text/javascript" src="../script/alpheios-toc.js"/>
