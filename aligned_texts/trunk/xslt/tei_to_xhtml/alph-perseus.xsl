...
<xsl:template match="l">
    <xsl:message>Div <xsl:value-of select="@n"/></xsl:message>
        <div class="l">
            <xsl:if test="@n">
...
<xsl:template match="wd">
 ...
 <xsl:template name="separate_words">
     ...
     <xsl:element name="span">
         <xsl:attribute name="class">alpheios-aligned-word</xsl:attribute>
    ...
    <xsl:template name="alpheios-pedagogical-header">
        ...
        <div class="alpheios-ignore">
            <div id="alph-page-header">
                <div class="alpheios-version-text"><a href="http://alpheios.net/content/release-notes" title="View Release Notes" target="_blank"></a></div>
            ...
            <ul id="alpheios-install-links">
                <caption>Please install or update the following Firefox Extensions required for optimal use of this site:</caption>
            </ul>
            <xsl:element name="br">
