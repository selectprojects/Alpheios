/**
 * @fileoverview Arabic specific string conversion methods 
 * Exports a single symbol, ConvertArabic which must be imported into the namespace 
...
const EXPORTED_SYMBOLS = ['ConvertArabic'];
...
/**
 * @class Arabic string conversion class
 * @extends Convert
 */
ConvertArabic = function()
{
    Convert.call(this);
}

ConvertArabic.prototype = new Convert();

/**
 * arabic ascii transliteration (unicode to Buckwalter)
 * @param {String} a_str the string to convert
 * @returns the converted string
 * @type {String}
 */
ConvertArabic.prototype.unicodeToBuckwalter = function(a_str)
{
