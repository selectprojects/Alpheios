...
pref("extensions.alpheios.greek.url.lexicon", 'http://perseus.harrysdell.com:8008');
pref("extensions.alpheios.greek.url.lexicon.request", "/hopper/melampus/xmlmorph-mp.jsp?word=<WORD>&input=Unicode");
